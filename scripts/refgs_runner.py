...
DATASET_CONFIGS: Dict[str, DatasetConfig] = {
    ...
    "glossy_synthetic": DatasetConfig(
        ...
        output_subdir="GlossySynthetic",
        train_script="train-NeRO.py",
        render_script="render.py",
        scenes=(
            _scene("bell", *COMMON_GLOSSY_ARGS, source_name="bell_blender"),
            _scene("tbell", *COMMON_GLOSSY_ARGS, source_name="tbell_blender"),
            _scene("potion", *COMMON_GLOSSY_ARGS, source_name="potion_blender"),
            _scene("teapot", *COMMON_GLOSSY_ARGS, source_name="teapot_blender"),
            _scene("luyu", *COMMON_GLOSSY_ARGS, source_name="luyu_blender"),
            _scene("cat", *COMMON_GLOSSY_ARGS, source_name="cat_blender"),
        ),
